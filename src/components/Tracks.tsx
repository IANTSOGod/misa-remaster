...
import { Brain, Database, Gamepad2, Globe, Shield, Smartphone } from 'lucide-react';
...
const Tracks = () => {
  ...
  const tracks = [
    ...
    },
    {
      ...
      skills: ['Ethical Hacking', 'Cryptographie', 'ISO 27001', 'CISSP', 'Kali Linux'],
    ...
    },
    {
      ...
      description: 'Traitement de données massives, analyse prédictive et business intelligence',
    ...
    },
    {
      ...
      description: 'Conception et développement de jeux vidéo, réalité virtuelle et augmentée',
  ...
  return (
    <section id="parcours" className="py-20 bg-gradient-to-br from-gray-50 to-red-50">
      <div className="container mx-auto px-10">
        ...
        >
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto font-montserrat leading-relaxed">
            Choisissez votre voie parmi nos 6 parcours de spécialisation conçus pour répondre aux
            besoins du marché et à vos aspirations professionnelles.
          </p>
        </motion.div>
        ...
        >
          <p className="text-lg text-gray-600 font-montserrat mb-6">
            Tous les parcours incluent un tronc commun solide en mathématiques, algorithmique et
            génie logiciel
          </p>
