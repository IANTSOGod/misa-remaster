        ...
        <div className="flex min-h-screen flex-col justify-center gap-20">
          ...
          >
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto font-montserrat leading-relaxed">
              Notre mention informatique forme les futurs experts du numérique à travers un cursus
              innovant alliant théorie fondamentale et pratique professionnelle.
            </p>
          </motion.div>
            ...
            >
              ...
              <div className="space-y-4 text-gray-700 font-montserrat">
                <p className="text-lg leading-relaxed">
                  Former des informaticiens polyvalents capables de s'adapter aux évolutions
                  technologiques et de répondre aux défis du monde numérique.
                </p>
                <p className="text-lg leading-relaxed">
                  Notre approche pédagogique privilégie l'apprentissage par projet, l'innovation et
                  la collaboration avec le monde professionnel.
                </p>
                <p className="text-lg leading-relaxed">
                  Nous préparons nos étudiants à devenir les leaders technologiques de demain grâce
                  à un enseignement de qualité et des infrastructures modernes.
                </p>
              </div>
            </motion.div>
        ...
        >
          {stats.map((stat, index) => (
            ...
            >
              ...
              <p className="text-gray-600 font-montserrat font-medium">{stat.label}</p>
            </motion.div>
          ))}
        </motion.div>
      </div>
